...
export default function Vault() {
  ...
  useEffect(() => {
    ...
    // Cleanup function to reset the ref when component unmounts or userEmail changes
    return () => {
      isFetchingRef.current = false;
    };
  }, [address]);
  ...
  // Show sign in screen if no user email
  if (!address) {
    return (
      <div className="relative w-full h-full font-spectral bg-white flex flex-col">
        {/* Header section */}
        ...
        <div className="flex-1 px-[40px] flex flex-col min-h-0 transition-all duration-300 ease-in-out overflow-hidden">
          <div className="flex-1 flex flex-col min-h-0 transition-all duration-300 ease-in-out mt-[20px] overflow-hidden">
            <div className="flex-1 flex flex-col justify-center items-center text-gray-500 text-lg">
              ...
              <button className="bg-black text-white px-6 py-3 rounded-lg cursor-pointer hover:bg-gray-800 transition-colors">
  ...
  return (
    <div className="relative w-full h-full font-spectral bg-white flex flex-col">
      ...
      <div className="flex-1 px-[40px] flex flex-col min-h-0 transition-all duration-300 ease-in-out overflow-hidden">
        <div className="flex-1 flex flex-col min-h-0 transition-all duration-300 ease-in-out mt-[20px] overflow-y-auto">
          {/* Header */}
          <div className="mb-6">
            <p className="text-gray-600">
              Accede a los documentos que Tomas te ha entregado o que tu has
              subido.
            </p>

            <p className="text-sm text-gray-500 mt-1">Conectado: {address}</p>
          </div>
