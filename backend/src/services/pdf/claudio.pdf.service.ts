...
export class ClaudioPDFService {
  ...
  /**
   * Generate a legal contract PDF with cover page and professional formatting
  ...
  async generatePdfContract(
    ...
    try {
      console.log("Generating legal contract PDF for Claudio...");
      ...
      if (options.uploadToCloud !== false) {
        ...
        try {
          ...
          console.log(`PDF contract saved temporarily as: ${tempFilePath}`);
