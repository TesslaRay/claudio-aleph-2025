/**
 * Options for generating Claudio legal proposals
 */
export interface ClaudioContractOptions {
  /** User Address */
  userAddress: string;
  /** Case ID */
  caseId: string;
...
export interface TomasInvestigatoOptions {
  ...
  /** Case ID */
  caseId: string;
  /** Language of the investigato report */
  language: string;
  /** The proposal content (supports markdown formatting) */
  content: string;
  /** Title of the proposal */
...
export interface TomasRespondeoOptions {
  ...
  /** Case ID */
  caseId: string;
  /** Language of the respondeo document */
  language: string;
